...
Route::get('/browse/{category:slug}', [FrontController::class,'category'])->name('front.catgeory');
...
Route::get('/order/finishes/{productTransaction:id}', [OrderController::class, 'orderfinished'])->name('front.order_finished');
